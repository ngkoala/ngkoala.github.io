...
describe('MdLiveAnnouncer', function () {
    ...
    beforeEach(testing_1.inject([testing_2.TestComponentBuilder, live_announcer_1.MdLiveAnnouncer], function (tcb, _live) {
        builder = tcb;
        live = _live;
    ...
    it('should correctly update the announce text', fakeAsyncTest(function () {
        var appFixture = null;
    ...
    it('should correctly update the politeness attribute', fakeAsyncTest(function () {
        var appFixture = null;
        builder.createAsync(TestApp).then(function (fixture) {
            appFixture = fixture;
        });
    ...
    it('should apply the aria-live value polite by default', fakeAsyncTest(function () {
        var appFixture = null;
        builder.createAsync(TestApp).then(function (fixture) {
            appFixture = fixture;
        });
    ...
    it('should allow to use a custom live element', fakeAsyncTest(function () {
        ...
        testing_1.getTestInjector().addProviders([
            { provide: live_announcer_1.LIVE_ANNOUNCER_ELEMENT_TOKEN, useValue: customLiveEl },
            live_announcer_1.MdLiveAnnouncer
        ]);
