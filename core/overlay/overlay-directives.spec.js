...
describe('Overlay directives', function () {
    ...
    it("should create an overlay and attach the directive's template", function () {
        expect(overlayContainerElement.textContent).toContain('Menu content');
    });
    it('should destroy the overlay when the directive is destroyed', testing_1.fakeAsync(function () {
        fixture.destroy();
    ...
    it('should use a connected position strategy with a default set of positions', function () {
        ...
        expect(strategy).toEqual(jasmine.any(connected_position_strategy_1.ConnectedPositionStrategy));
