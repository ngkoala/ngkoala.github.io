...
describe('GlobalPositonStrategy', function () {
    ...
    it('should set explicit (top, left) position to the element', fakeAsyncTest(function () {
    ...
    it('should set explicit (bottom, right) position to the element', fakeAsyncTest(function () {
    ...
    it('should overwrite previously applied positioning', fakeAsyncTest(function () {
    ...
    it('should center the element', fakeAsyncTest(function () {
        strategy.centerHorizontally().centerVertically().apply(element);
        testing_1.flushMicrotasks();
    ...
    it('should center the element with an offset', fakeAsyncTest(function () {
    ...
    it('should default the element to position: absolute', fakeAsyncTest(function () {
        strategy.apply(element);
        testing_1.flushMicrotasks();
        expect(element.style.position).toBe('absolute');
    }));
    it('should make the element position: fixed', fakeAsyncTest(function () {
