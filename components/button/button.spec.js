...
describe('MdButton', function () {
    ...
    it('should apply class based on color attribute', function (done) {
    ...
    it('should should not clear previous defined classes', function (done) {
        return builder.createAsync(TestApp).then(function (fixture) {
            var testComponent = fixture.debugElement.componentInstance;
            var buttonDebugElement = fixture.debugElement.query(platform_browser_1.By.css('button'));
    ...
    describe('button[md-button]', function () {
        it('should handle a click on the button', function (done) {
            return builder.createAsync(TestApp).then(function (fixture) {
                var testComponent = fixture.debugElement.componentInstance;
                var buttonDebugElement = fixture.debugElement.query(platform_browser_1.By.css('button'));
        ...
        it('should not increment if disabled', function (done) {
            return builder.createAsync(TestApp).then(function (fixture) {
                var testComponent = fixture.debugElement.componentInstance;
                var buttonDebugElement = fixture.debugElement.query(platform_browser_1.By.css('button'));
    ...
    describe('a[md-button]', function () {
        it('should not redirect if disabled', function (done) {
            return builder.createAsync(TestApp).then(function (fixture) {
                var testComponent = fixture.debugElement.componentInstance;
        ...
        it('should remove tabindex if disabled', function (done) {
            return builder.createAsync(TestApp).then(function (fixture) {
                var testComponent = fixture.debugElement.componentInstance;
                var buttonDebugElement = fixture.debugElement.query(platform_browser_1.By.css('a'));
        ...
        it('should add aria-disabled attribute if disabled', function (done) {
            return builder.createAsync(TestApp).then(function (fixture) {
                var testComponent = fixture.debugElement.componentInstance;
                var buttonDebugElement = fixture.debugElement.query(platform_browser_1.By.css('a'));
                fixture.detectChanges();
