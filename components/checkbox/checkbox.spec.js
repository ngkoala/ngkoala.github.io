...
describe('MdCheckbox', function () {
    ...
    describe('basic behaviors', function () {
        ...
        it('should change from indeterminate to checked on click', function () {
            testComponent.isChecked = false;
            testComponent.isIndeterminate = true;
            fixture.detectChanges();
            expect(checkboxInstance.checked).toBe(false);
            expect(checkboxInstance.indeterminate).toBe(true);
            checkboxInstance._onInteractionEvent({ stopPropagation: function () { } });
            expect(checkboxInstance.checked).toBe(true);
        ...
        it('should overwrite indeterminate state when checked is re-set', function () {
            testComponent.isIndeterminate = true;
            fixture.detectChanges();
            testComponent.isChecked = true;
            fixture.detectChanges();
        ...
        it('should add a css class to end-align the checkbox', function () {
        ...
        it('should trigger a change event when the native input does', testing_1.async(function () {
    ...
    describe('with change event and no initial value', function () {
        ...
        it('should not emit a DOM event to the change output', testing_1.async(function () {
            fixture.detectChanges();
    ...
    describe('with provided aria-label ', function () {
        ...
        var checkboxNativeElement;
        var inputElement;
        it('should use the provided aria-label', testing_1.async(function () {
    ...
    describe('with provided aria-labelledby ', function () {
        ...
        var checkboxNativeElement;
        var inputElement;
        it('should use the provided aria-labelledby', testing_1.async(function () {
        ...
        it('should not assign aria-labelledby if none is provided', testing_1.async(function () {
            builder.createAsync(SingleCheckbox).then(function (f) {
                fixture = f;
                checkboxDebugElement = fixture.debugElement.query(platform_browser_1.By.directive(checkbox_1.MdCheckbox));
                checkboxNativeElement = checkboxDebugElement.nativeElement;
    ...
    describe('with provided tabIndex', function () {
        ...
        it('should preserve any given tabIndex', testing_1.async(function () {
    ...
    describe('with ngModel', function () {
        ...
        it('should be in pristine, untouched, and valid states initially', testing_1.fakeAsync(function () {
    ...
    describe('with name attribute', function () {
        ...
        it('should forward name value to input element', testing_1.fakeAsync(function () {
            var checkboxElement = fixture.debugElement.query(platform_browser_1.By.directive(checkbox_1.MdCheckbox));
...
var SingleCheckbox = (function () {
    ...
    SingleCheckbox.prototype.onCheckboxChange = function (event) { };
