...
describe('MdTabGroup', function () {
    ...
    describe('basic behavior', function () {
        ...
        it('should support two-way binding for selectedIndex', testing_1.async(function () {
        ...
        it('should cycle through tab focus with focusNextTab/focusPreviousTab functions', testing_1.fakeAsync(function () {
        ...
        it('should change tabs based on selectedIndex', testing_1.fakeAsync(function () {
            var component = fixture.componentInstance;
            var tabComponent = fixture.debugElement.query(platform_browser_1.By.css('md-tab-group')).componentInstance;
    ...
    describe('async tabs', function () {
        ...
        it('should show tabs when they are available', testing_1.async(function () {
     ...
     * `md-active` class
     */
    function checkSelectedIndex(index, fixture) {
        fixture.detectChanges();
