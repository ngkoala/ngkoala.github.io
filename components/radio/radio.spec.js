...
describe('MdRadio', function () {
    ...
    beforeEach(function () {
        testing_1.addProviders([
            ...
            { provide: unique_selection_dispatcher_1.MdUniqueSelectionDispatcher, useFactory: function () {
    ...
    describe('inside of a group', function () {
        ...
        it('should set alignment based on the group alignment', function () {
        ...
        it('should emit a change event from radio buttons', testing_1.fakeAsync(function () {
            expect(radioInstances[0].checked).toBe(false);
        ...
        it('should emit a change event from the radio group', testing_1.fakeAsync(function () {
            expect(groupInstance.value).toBeFalsy();
        ...
        // a focus / blur event.
        it('should focus individual radio buttons', function () {
            var nativeRadioInput = radioNativeElements[0].querySelector('input');
    ...
    describe('group with ngModel', function () {
        ...
        it('should have the correct control state initially and after interaction', testing_1.fakeAsync(function () {
        ...
        it('should update the ngModel value when selecting a radio button', testing_1.fakeAsync(function () {
            radioInstances[1].checked = true;
            fixture.detectChanges();
            testing_1.tick();
    ...
    describe('group with ngModel and change event', function () {
        var fixture;
        var groupDebugElement;
        var groupNativeElement;
        var radioDebugElements;
        ...
        it('should update the model before firing change event', testing_1.fakeAsync(function () {
